...
module.exports.destroy = async function(req ,res){
    ...
    try{
      ...
      // now we are applying authentication and authorization for deleting a post
      if(post.user == req.user.id){

        // till here we are authencticating user vis broswer and stores user info in cookie file
      // in next will authenticate user via postman using JWT because, as API's do not have cookies
         ...
         console.log("Deleted Commnets: ",deletedComments);
         if(deletedComments) {
